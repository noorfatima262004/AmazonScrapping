...
class WelcomePage(QDialog):
    def __init__(self):
        ...
        loadUi(r"D:\3 semester\DSA\Mid Project\Final\Final\ui\welcomePage.ui", self)
...
class ScrapingPage:
        ...
        try:
            ...
            if list_price_tag:
                ...
                if list_price_match:
                    ...
                    return int(round(float(list_price)))
        ...
        if soup:
            try:
                ...
                if rating_tag:
                    ...
                    if rating:
                        return int(round(float(rating.group(1).replace(',', ''))))
                    else:
    ...
    def load_and_show_data(self):
        data = self.load_data_from_csv("(New1).csv")
...
class SortingPage(QMainWindow):
    def __init__(self):
     try:
        ...
        loadUi(r"D:\3 semester\DSA\Mid Project\Final\Final\ui\Sorting Page.ui", self)
        ...
        self.scrapping_page = ScrappingWindow()
        ...
        self.ScrappingButton.clicked.connect(self.show_Scrapping_page)
        ...
        # self.Resume.clicked.connect(self.resume_scrapping)
         ...
         print("Error occurred during opeing  sorting page :", str(e))
         return
    ...
    def show_Scrapping_page(self):
        self.hide()
        self.scrapping_page.show()
    ...
    def show_scrapping_page(self):
        self.hide()
        self.show_scrapping_page()
    def close_application(self):
        app.quit()

class ScrappingWindow(QMainWindow):
    def __init__(self):
     try:
        super(ScrappingWindow, self).__init__()
        loadUi(r"D:\3 semester\DSA\Mid Project\Final\Final\ui\Scrapping.ui", self)
        self.SearchingButton.clicked.connect(self.show_searching_page)
        self.ExitButton.clicked.connect(self.close_application)
        self.MenuButton.clicked.connect(self.show_welcome_page)
        self.load_and_show_data()
        self.searching_page = None
        ...
        self.SortingButton.clicked.connect(self.show_sorting_page)
         ...
         print("Error occurred during opeing scrapping:", str(e))
         return
...
class SearchingPage(QMainWindow):
    def __init__(self):
     try:
        ...
        loadUi(r"D:\3 semester\DSA\Mid Project\Final\Final\ui\Searching Final.ui", self)
        self.MenuButton.clicked.connect(self.show_welcome_page)
        self.SortingButton.clicked.connect(self.show_sorting_page)
        self.ScrappingButton.clicked.connect(self.show_scrapping_page)
        self.ExitButton.clicked.connect(self.close_application)
